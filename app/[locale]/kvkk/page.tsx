...
export default function KvkkPage() {
  ...
  const pdfUrl = "/pdfs/bulbi-aydinlatma-metni.pdf";
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 p-8 sm:p-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 mb-8">
            ...
            <a href={pdfUrl} download className="flex items-center gap-2 bg-green-50 text-green-600 hover:bg-green-100 px-5 py-2.5 rounded-xl font-bold transition-colors">
